...
def spell(player, numbered_opponents):
    ...
    while _condition == False:
        ...
        spell = str(input('- '))
        if spell in ['exit','stop','quit','cancel']:
            return None, None
        ...
        print('Type exit/stop/quit or pick a spell to cast.')
...
classes = {
    ...
    'warrior':Warrior}
options = {
    'warrior':'1: One big sword ( 5 damage )or \n2: One sword and sheild ( 3 damage, +1 AC)',
    'mage':'1: One super damage spell ( 3 ) + health potion \n2: One regular damage spell ( 2 damage ) + 1 healing spell',
    'rogue':'1: Knives + health potion \n2: Knives + better cloak'}
